...
define config.name = _("Ikigai University")
...
define config.main_menu_music = "Audio/Music/Kimi to Boku Ver. 2 (Main Theme).mp3"
...
define build.name = "IkigaiUniversity"
...
define config.save_directory = "IkigaiUniversity-1762103530"
